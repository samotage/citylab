...
description: "Pipeline step 3.5/6. Operator-driven. Create and generate a visual storyboard for an approved content piece. Author markdown, validate, generate images, review. Runs between approval (step 30) and export (step 40)."
license: MIT
metadata:
  author: otagelabs
  version: "1.0"
