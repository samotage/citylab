...
description: "Pipeline step 6/6. Automatic — runs after SEO. Commit blog changes, create and merge PR to main, verify Vercel production deployment. No operator gates. Runs on the website, not Kenwood."
---
