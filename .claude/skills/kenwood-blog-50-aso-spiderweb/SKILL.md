...
description: "Pipeline step 5/6. Automatic — runs after export. Weave a newly exported post into the blog corpus with bidirectional cross-links and ASO checks. Non-destructive changes applied autonomously. Runs on the website, not Kenwood."
---
