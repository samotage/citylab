---
name: generate-pdf
description: Generate a PDF from an HTML file using WeasyPrint, or capture a live web page using Puppeteer. Use this skill when asked to create, export, or generate a PDF.
allowed-tools:
