...
description: Generate slide decks from markdown using MARP. Use this skill when producing a presentation — slides for a meeting, briefing, workshop, pitch, board update, investor deck, or any deliverable where the audience and delivery context call for slide format rather than a document. Outputs HTML, PDF, or PPTX. Uses the otageLabs house theme by default.
allowed-tools:
  - Read
  - Write
  - Edit
