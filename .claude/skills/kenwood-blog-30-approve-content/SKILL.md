...
description: "Pipeline step 3/6. Generate editorial metadata (summary, meta description, tags) for a content piece, then transition to approved. Last operator gate before the automatic publishing pipeline."
---
