...
| 70 | `review-prd-set` | Adversarial cross-PRD review for cohort alignment |
...
30: prd-validate     →  Quality gate (individual)
70: review-prd-set   →  Adversarial cross-PRD review (batch)
...
2. After batch PRD review - remediate cross-PRD findings
3. After OpenSpec proposal creation - review/adjust/approve
4. After testing - verify functionality works as expected
5. After PR creation - merge the pull request
...
1. **Review PRD cohort for cross-cutting issues:**
   ```
   70: review-prd-set
   ```
...
└── prds/                        # PRD management commands
    ├── README.md
    ├── 05-sprint-prompts.md    # Generate sprint prompts from roadmap
    ├── 10-workshop.md          # PRD workshop
    ├── 20-list.md              # List PRDs
    ├── 30-validate.md          # Validate PRDs
    ├── 40-sequence.md          # Sequence PRDs
    └── 70-review-prd-set.md    # Adversarial cross-PRD review
```
