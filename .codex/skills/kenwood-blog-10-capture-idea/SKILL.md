...
description: Pipeline step 1/6. Quick-capture a raw blog post idea into Kenwood. Pit
  stop, not a workshop — get the spark down and get out.
metadata:
  short-description: Pipeline step 1/6.
---
