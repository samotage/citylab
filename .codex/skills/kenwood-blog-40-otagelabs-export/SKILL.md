...
description: Pipeline step 4/6. Automatic — runs after approval. Export an approved
  content piece to the otageLabs website blog. Transforms frontmatter, copies storyboard
  images, starts dev server. No operator gates.
license: MIT
metadata:
  author: otagelabs
  version: '2.0'
  short-description: Pipeline step 4/6.
---
