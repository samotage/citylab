...
description: Publish approved content variants to their platforms and verify every
  published URL is live with correct content and working links. Run after variant
  generation and review. The post-and-validate step of the variant pipeline.
metadata:
  short-description: Publish approved content variants to their platforms and verify
    every published URL is live with correct content and ...
---
