---
description: Commit changes and create a PR to main while keeping branch-specific
  files separate.
---
...
**Always present this checkpoint fresh — do not skip it based on previous analysis or cached categorization.**
...
Co-Authored-By: <co-author line — see below>"
```
...
4. **Apply main-worthy changes only:**
   ...
   Co-Authored-By: <co-author line — same format as above>"
   ```
