...
Your first response after this command is run must only ask me for the required input. Do NOT attempt to infer the change name from the branch or context. Always ask.
