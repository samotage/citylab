---
description: Bidirectional spec-vs-code reconciliation audit. Finds unimplemented
  specs, unwired code, spec drift, redundant duplication, and accidental complexity
  — with sympathy for earned complexity.
---
